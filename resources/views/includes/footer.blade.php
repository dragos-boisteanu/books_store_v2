<footer>
    <div class="footer__list links">
        ...
        <ul class="list list__content">
            ...
            <li class="item">
                <a class="link" href="/">Newest books</a>
            </li>
            <li class="item">
                <a class="link" href="/">Most viewed books</a>
            </li>
            <li class="item">
                <a class="link" href="/">Most sold books</a>
            </li>
            <li class="item">
    ...
    <div class="footer__list contact">
        ...
        <ul class="list list__content">
            <li class="contact__item">
                ...
                <ul class="list phones__list">
                    <li class="phone__item">
                        <span class="provider orange">Orange</span>
                        <span class="number">088283823</span>
                    </li>
                    <li class="phone__item">
                        <span class="provider vodafone">Vodafone</span>
                        <span class="number">088283823</span>
                    </li>
                    <li class="phone__item">
                        <span class="provider digi">Digi</span>
                        <span class="number">088283823</span>
                    </li>
                </ul>
            </li>
